...
public class UsbHidKbd_es_ES extends UsbHidKbd {

    public UsbHidKbd_es_ES() {
        ...
        kbdVal.put("ç",                  new byte[] {0x00, 0x00, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("ñ",                  new byte[] {0x00, 0x00, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("´",                  new byte[] {0x00, 0x00, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                     0x00, 0x00, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("º",                  new byte[] {0x00, 0x00, 0x35, 0x00, 0x00, 0x00, 0x00, 0x00} );
        ...
        kbdVal.put("Ç",                  new byte[] {0x02, 0x00, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("Ñ",                  new byte[] {0x02, 0x00, 0x33, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("¨",                  new byte[] {0x02, 0x00, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                     0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                                     0x02, 0x00, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("ª",                  new byte[] {0x02, 0x00, 0x35, 0x00, 0x00, 0x00, 0x00, 0x00} );
        ...
        kbdVal.put("}",                  new byte[] {0x40, 0x00, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("{",                  new byte[] {0x40, 0x00, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00} );
        kbdVal.put("\\",                 new byte[] {0x40, 0x00, 0x35, 0x00, 0x00, 0x00, 0x00, 0x00} );
